...
import org.springframework.stereotype.Component;
	...
	public class BookingDetailsLoader implements CommandLineRunner{
		...
		public void run(String...strings) throws Exception {
			this.repository.save(new BookingDetails("1","1", "t1","1","sks", "Raipur","Delhi","1","2143658709","26.04.2020","CONFIRMED"));
			this.repository.save(new BookingDetails("2","2", "t2","1","sks", "Hyderabad","Bangalore","1","2143658708","26.04.2020","CONFIRMED"));
		}
	}